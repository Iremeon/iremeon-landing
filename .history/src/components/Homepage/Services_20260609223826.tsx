...
const Services: React.FC = () => {
  return (
    <section id="services" className="scroll-mt-18 py-20 bg-bgcolor-200 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-4">
        <div className="p-8 bg-white rounded-2xl shadow-lg">
          <div className="w-16 h-16 bg-primarycolor-100 rounded-2xl flex items-start justify-center mb-6">
