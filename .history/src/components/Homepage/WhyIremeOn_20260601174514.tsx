...
const WhyIremeOn: React.FC = () => {
  return (
    <section className="py-20 bg-bgcolor-300 text-center">
      ...
      <Button variant="primary" className='flex items-center gap-2 mx-auto shadow-xl hover:shadow-2xl transition-shadow duration-300 text-sm md:text-base px-4 md:px-6 py-2 md:py-3 w-[90%] md:w-auto'>
