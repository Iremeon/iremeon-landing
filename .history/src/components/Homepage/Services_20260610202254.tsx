...
const Services: React.FC = () => {
  return (
    <section id="services" className="scroll-mt-18 py-20 bg-bgcolor-200">
      <h2 className="text-4xl font-bold mb-6 text-textcolor-100 text-center">Our Services</h2>
      <p className="text-textcolor-200 mb-16 text-lg text-center">We craft digital solutions that empower businesses to grow and innovate.</p>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-4 align-items-center">
